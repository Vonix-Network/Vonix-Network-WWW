...
export default function EditCategoryPage({ params }: EditCategoryPageProps) {
    ...
    const fetchCategory = async () => {
      try {
        ...
        setFormData({
          ...
          createPermission: category.createPermission || 'user',
          replyPermission: category.replyPermission || 'user',
          viewPermission: category.viewPermission || 'user',
        });
      } catch (error) {
  ...
  const handleDelete = async () => {
    if (!confirm('Are you sure you want to delete this category? This will also delete all posts in this category. This action cannot be undone.')) {
      return;
    }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-2">Modify category settings and permissions</p>
          </div>
        </div>
        <Button
          variant="destructive"
