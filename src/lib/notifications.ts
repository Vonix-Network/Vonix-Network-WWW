...
export async function notifyNewMessage(userId: number, senderName: string, messageId: number) {
...
export async function notifyFriendRequest(userId: number, requesterName: string, requesterId: number) {
  return createNotification({
    userId,
    type: 'friend_request',
...
export async function notifyForumReply(userId: number, replierName: string, topicId: number) {
  return createNotification({
    userId,
    type: 'forum_reply',
    title: 'New Reply',
    message: `${replierName} replied to your forum topic`,
